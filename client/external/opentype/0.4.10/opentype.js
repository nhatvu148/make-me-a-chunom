...
function parseCmapTable(data, start) {
    ...
    // We look for format 12 first (supports characters > U+FFFF), then fall back to format 4.
    ...
    for (i = 0; i < cmap.numTables; i += 1) {
        ...
        // Platform 3 (Windows), encoding 10 (Unicode UCS-4) - format 12
        if (platformId === 3 && encodingId === 10) {
            offset12 = tableOffset;
        }
        // Platform 3 (Windows), encoding 1 or 0 (Unicode BMP) - format 4
        if (platformId === 3 && (encodingId === 1 || encodingId === 0)) {
            offset4 = tableOffset;
        }
    }

    // Prefer format 12 for full Unicode support
    var offset = offset12 !== -1 ? offset12 : offset4;
